...
class QLearningAgent:
    ...
    def _update(
        ...
        """
        # Truncation (the 200-step time limit) is not a real terminal state, so
        # we keep bootstrapping through it and only drop the future term when
        # the car actually reached the flag.
